...
},{"ol/src/renderer/Layer":"node_modules/ol/src/renderer/Layer.js"}],"scripts/indentify.js":[function(require,module,exports) {
"use strict";
...
map.on('singleclick', function (evt) {
  if ($('#draggable-title').text() !== "Measure") {
    ...
    var hdms = (0, _coordinate.toStringHDMS)((0, _proj.toLonLat)(coordinate)); // Get the layer by its name
      ...
      $.ajax({
        ...
        success: function success(result) {
          ...
          if (building) {
            ...
            buildingInfo.html("\n            <h5>Building info</h5> <p>building Number:".concat(buildingNumber, "</p> <p>building (sqm) :").concat(buildingArea.toFixed(2), " </p>"));
            noFeatures.html('');
          }
        }
      });
...
},{"ol/ol.css":"node_modules/ol/ol.css","ol/Overlay":"node_modules/ol/Overlay.js","ol/proj":"node_modules/ol/proj.js","ol/coordinate":"node_modules/ol/coordinate.js","./customFunctions":"scripts/customFunctions.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/indentify.js"], null)
//# sourceMappingURL=/indentify.1783d5d2.js.map